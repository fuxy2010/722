...
int CBroadcastThread::broadcast()
{
    ...
    
    {
        ...
        //if(NULL != _rtp_send_session) _rtp_send_session->send_rtp_packet(_audio_packet, packet_len, G711RTPPacket, true, AUDIO_SAMPLING_RATE, 1);
        _rtp_send_session.send_rtp_packet(_audio_packet, packet_len, G711RTPPacket, true, AUDIO_SAMPLING_RATE, 1);
    }    
