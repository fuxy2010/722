...
//fym ´¦Àí·ÇRTSPÇëÇóÊý¾Ý»Øµ÷º¯ÊýÀàÐÍ
#ifdef __linux__
typedef void (*DataCallBackFunc)(const char* data, const unsigned long& length);
#else
typedef void (*DataCallBackFunc)(const char* data, const unsigned long& length);
#endif
...
class QTSServer : public QTSServerInterface
{
	...
	public://fym
		static DataCallBackFunc fDataCallBackFunc;//fym ´¦ÀíÊÕµ½µÄ·ÇRTSPÇëÇóÊý¾Ý
};
