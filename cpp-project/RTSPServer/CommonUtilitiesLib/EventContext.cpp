    ...
    fAutoCleanup(true)
{
	...
	size_t s1 = sizeof(fUniqueID);
	size_t s2 = sizeof(int);
	size_t s3 = sizeof(unsigned int);
	size_t s5 = sizeof(unsigned long);
	size_t s6 = sizeof(unsigned long long);
	int b1 = true;
	int b2 = false;
	int i = 0;
	++i;
...
void EventContext::RequestEvent(int theMask)
{
    ...
    {
		//qtss_printf("\n>>>>>>>>> EventContext::RequestEvent 1");//fym
    ...
    {
		//qtss_printf("\n>>>>>>>>> EventContext::RequestEvent 2");//fym
