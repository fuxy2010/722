...
enum
{
	...
	//fym
	 QTSS_AddRelaySource_Role =  FOUR_CHARS_TO_INT('a', 'r', 's', 'c'),  //arsc Ôö¼Ó×ª·¢Ô´
	 QTSS_RemoveRelaySource_Role =  FOUR_CHARS_TO_INT('r', 'r', 's', 'c'),  //rrsc É¾³ý×ª·¢Ô´
	 QTSS_InputStreamData_Role =  FOUR_CHARS_TO_INT('i', 'p', 's', 'd'),  //ipsd //ÊäÈëÃ½ÌåÊý¾Ý´ý×ª·¢
	 //QTSS_RemoveReflectorSession_Role =  FOUR_CHARS_TO_INT('r', 'm', 'r', 's'),  //ipsd //É¾³ý×ª·¢Session
...
//fym ÊäÈëÃ½ÌåÊý¾Ý°ü½á¹¹
typedef struct
{
	UInt16						in_relay_source_uuid;
	char*                       in_packet_data;
	UInt32                      in_packet_len;
	UInt16						in_packet_type;
	UInt64						in_time_stamp_ssrc;//fym just for old version
} QTSS_RelayStreamData_Params;
...
typedef union
{
	...
	QTSS_RelayStreamData_Params			relay_stream_data;//fym
