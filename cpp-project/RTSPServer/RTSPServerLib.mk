...
$(OutputFile): $(Objects)
	...
	@$(MakeDirCommand) "/home/fym/722/cpp-project/.build-debug"
	@echo rebuilt > "/home/fym/722/cpp-project/.build-debug/RTSPServerLib"
...
$(IntermediateDirectory)/Server.tproj_Win32LibMain.cpp$(ObjectSuffix): Server.tproj/Win32LibMain.cpp $(IntermediateDirectory)/Server.tproj_Win32LibMain.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/fym/722/cpp-project/RTSPServer/Server.tproj/Win32LibMain.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Server.tproj_Win32LibMain.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Server.tproj_Win32LibMain.cpp$(DependSuffix): Server.tproj/Win32LibMain.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/Server.tproj_Win32LibMain.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/Server.tproj_Win32LibMain.cpp$(DependSuffix) -MM Server.tproj/Win32LibMain.cpp

$(IntermediateDirectory)/Server.tproj_Win32LibMain.cpp$(PreprocessSuffix): Server.tproj/Win32LibMain.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/Server.tproj_Win32LibMain.cpp$(PreprocessSuffix) Server.tproj/Win32LibMain.cpp
...
$(IntermediateDirectory)/Server.tproj_RunServerLib.cpp$(ObjectSuffix): Server.tproj/RunServerLib.cpp $(IntermediateDirectory)/Server.tproj_RunServerLib.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/fym/722/cpp-project/RTSPServer/Server.tproj/RunServerLib.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Server.tproj_RunServerLib.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/Server.tproj_RunServerLib.cpp$(DependSuffix): Server.tproj/RunServerLib.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/Server.tproj_RunServerLib.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/Server.tproj_RunServerLib.cpp$(DependSuffix) -MM Server.tproj/RunServerLib.cpp

$(IntermediateDirectory)/Server.tproj_RunServerLib.cpp$(PreprocessSuffix): Server.tproj/RunServerLib.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/Server.tproj_RunServerLib.cpp$(PreprocessSuffix) Server.tproj/RunServerLib.cpp
